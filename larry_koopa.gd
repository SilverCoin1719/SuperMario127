...
onready  var head:AnimatedSprite = $head
onready  var body:AnimatedSprite = $body
onready  var kinematic_body:KinematicBody2D = $LarryKoopa
onready  var attack_area:Area2D = $LarryKoopa / AttackArea
onready  var stomp_area:Area2D = $LarryKoopa / StompArea
onready  var player_detector:Area2D = $LarryKoopa / PlayerDetector
onready  var platform_detector:Area2D = $LarryKoopa / PlatformDetector
onready  var wall_check:RayCast2D = $LarryKoopa / WallCheck
onready  var wall_vacant_check:RayCast2D = $LarryKoopa / WallVacantCheck
onready  var pit_check:RayCast2D = $LarryKoopa / PitCheck
onready  var particles:Particles2D = $LarryKoopa / Poof
onready  var stomp_sound:AudioStreamPlayer2D = $LarryKoopa / Stomp
onready  var poof_sound:AudioStreamPlayer2D = $LarryKoopa / Disappear
onready  var hit_sound:AudioStreamPlayer2D = $LarryKoopa / Hit
onready  var anim_player:AnimationPlayer = $LarryKoopa / AnimationPlayer
onready  var bottom_pos:Node2D = $LarryKoopa / BottomPos
onready  var water_detector:Node2D = $LarryKoopa / WaterDetector
